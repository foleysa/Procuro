...
export const DATA_FACTORY_PACKAGES: readonly DataFactoryPackageMeta[] = [
  ...
  },
  {
    ...
    description:
      "UFLPA, USITC/ITA remedies + DataWeb/HTS, Companies House, WDI, Panama Canal cite, PHMSA, Wikidata reconcile. ACLED license-gated.",
    family: "mixed",
  ...
  {
    id: "pkg_tier_c",
    title: "Day 0 light Tier C backlog",
    description:
      "BIS Entity/Denied Persons, OpenSanctions (UK/EU files), FRA/STB extras, NOAA PORTS, OpenCorporates ToS gate, OWID cite helper, USPTO ODP, FTC/AG RSS. Do not block the PR on live collectors.",
    family: "mixed",
    sourceIds: TIER_C_SOURCE_IDS,
    channelUse: "both",
    pulseSurface: "both",
    release: DATA_FACTORY_RELEASE,
  },
